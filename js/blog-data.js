const blogData = {
  tips: {
    ...
    content: `
      ...
      <h3>3. Use Secure Communication</h3>
      <p>Always use our integrated WhatsApp communication channel. This allows us to maintain a record of the interaction in case of disputes. Scammers often try to lure buyers away from the platform to unmonitored chat apps; never share personal financial details outside of our secure recommendations.</p>
  ...
  updates: {
    title: "Introducing Global Ads: The Future of Seller Promotion",
    category: "UPDATES",
    date: "March 25, 2026",
    ...
    content: `
      ...
      <ul>
        <li><strong>Increased Reach:</strong> Ad listings see a 70% higher engagement rate than standard products.</li>
        <li><strong>Targeted Traffic:</strong> We drive buyers who are specifically looking for what you sell.</li>
        <li><strong>Premium Branding:</strong> Ad listings feature custom badges that build immediate buyer trust.</li>
      </ul>
      
      <p>Ready to take your business to the next level? Head to your Seller Hub and click 'Advertise My Product' to get started today.</p>
    `
  },
  insights: {
    title: "The Future of Reselling: Market Trends for 2026",
    category: "INSIGHTS",
    date: "March 20, 2026",
    ...
    content: `
      ...
      <h3>Property and Rentals</h3>
      <p>Our addition of the 'Houses & Rents' category has tapped into a massive need for transparent real estate listings. By allowing admins to moderate these high-value transactions, we are becoming the go-to source for reliable property information.</p>
